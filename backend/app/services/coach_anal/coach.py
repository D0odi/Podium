...
def coach_result(transcript, deep_analysis, dg_response, stutters, wpm, speech_duration, filler_words, target_goal_seconds: int | None = None):
    ...
    prompt_for_gemini = (
        ...
        "list exactly three strengths (upsides) and three concrete areas to improve (shortcomings). Upsides and shortcomings need to be clear and concise (max 10 words) "
